...
\newcommand{\assessmentdate}{July 29, 2016}
...
\newcommand{\activitysummary}{
    ...
    Student Robotics Southampton and managed by the Smallpeice Trust.
...
\newcommand{\references}{
    ...
    \reference{University policy on children and young people in the workplace (attached).}
}
