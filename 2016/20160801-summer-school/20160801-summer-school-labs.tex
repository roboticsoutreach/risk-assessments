...
\newcommand{\activitylocation}{Physics L3 Labs (Building 46),
...
\newcommand{\activitysummary}{
    ...
    This risk assessment specifically covers the use of the physics and
    electronics laboratories for taught laboratory sessions and robot
...
\newcommand{\risks}{
    ...
    \risk
        ...
        {\item The ESO\esofootnote will verify that all wiring in the robots is
         sufficiently insulated before they are allowed to be tested.}
        {1} % Likelihood (/3)
        {2} % Impact (/3)
