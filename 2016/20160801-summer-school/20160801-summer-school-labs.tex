...
\newcommand{\activitysummary}{
    ...
    Additionally, the risks and controls outlined in the General ECS Teaching
    Lab Risk Assessment should also be considered. Although chemicals, high
    voltages/currents and high temperatures are not used for this activity,
    people using the laboratory should be made aware that these hazards could be
    present elsewhere in the laboratory.
}
