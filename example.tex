...
% Optional additional LaTeX source that is placed after the table of risks,
% before the page break. An example use of this command is to discuss additional
% risks that don't fit into the structure of the table.
\newcommand{\postrisks}{
    Some more text.
}
