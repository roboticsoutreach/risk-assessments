...
\newcommand{\hscfootnote}{\footnote{Health and Safety Coordinator; for the duration of this event, this role will be filled by Kier Davis (\email{me@kierdavis.com}).}}


\newcommand{\groupname}{Southampton Competitive Robotics Outreach}
\newcommand{\assessorname}{Kier Davis}
\newcommand{\assessoremail}{me@kierdavis.com}
\newcommand{\assessmentdate}{February 14, 2018}


\newcommand{\activityname}{SourceBots - Tech Day}
\newcommand{\activitydate}{February 17, 2018}
...
\newcommand{\activitysummary}{
    ...
    The event is one of a number of Tech Days, which are opportunities for the
    teams to come on site to spend the day developing their robots while
    receiving support from the programme organisers and interacting with other
    teams.
